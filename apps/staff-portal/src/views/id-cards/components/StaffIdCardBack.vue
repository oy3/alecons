    ...
    <div class="id-card-back" :style="cardStyle">
      ...
      <div class="back-footer-area">
        ...
        <div class="back-footer">
          <img v-if="barcodeDataUrl" :src="barcodeDataUrl" class="barcode-img" :alt="cardData.staffId" />
...
export default {
  ...
  methods: {
    ...
    generateBarcode() {
      const rawValue = this.cardData?.staffId
      if (!rawValue) {
...
.barcode-img { height: 34px; background: #fff; padding: 2px 8px; display: inline-block; }
