        ...
        <div class="modal-body">
          ...
          <div v-if="activeFormat === 'excel'">
            <div class="alert alert-info">
              <h6>
                <i class="bi bi-table me-2"></i>Excel/CSV Column Structure
              </h6>
              <p class="mb-0">
                Use the exact column headers below in your spreadsheet:
              </p>
            </div>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="badge bg-warning text-dark">MCQ Only</span>
                    </td>
                    <td>First option</td>
                    <td>Lagos</td>
                  </tr>
            ...
            <div class="row">
              <div class="col-md-6">
                <h6>
                  <i class="bi bi-check-circle text-success me-2"></i>Excel
                  Example
                </h6>
          ...
          <div v-if="activeFormat === 'pdf'">
            <div class="alert alert-warning">
              ...
              <p class="mb-0">
                PDF questions are parsed using AI. Structure your content
...
<strong>3. Explain the concept of object-oriented programming.</strong>
   ...
   <em>Marks: 10</em>
              ...
              <div class="col-md-4">
                <h6>
                  <i class="bi bi-lightbulb me-2"></i>Tips for Better Parsing
                </h6>
                <ul class="list-unstyled">
                  <li>
                    <i class="bi bi-check text-success me-2"></i>Number
                    questions clearly (1., 2., 3.)
                  </li>
                  <li>
                    <i class="bi bi-check text-success me-2"></i>Use consistent
                    option formatting (a), b), c))
                  </li>
                  <li>
                    <i class="bi bi-check text-success me-2"></i>Mark answers
                    clearly with "Answer:"
                  </li>
                  <li>
                    <i class="bi bi-check text-success me-2"></i>Specify marks
                    with "Marks:" or "Points:"
                  </li>
                  <li>
                    <i class="bi bi-check text-success me-2"></i>Use good
                    contrast and readable fonts
                  </li>
                  <li>
                    <i class="bi bi-x text-danger me-2"></i>Avoid handwritten
                    text
                  </li>
                  <li>
                    <i class="bi bi-x text-danger me-2"></i>Avoid complex tables
                    or graphics
                  </li>
                </ul>
              </div>
          ...
          <div v-if="activeFormat === 'docx'">
            <div class="alert alert-info">
              <h6>
                <i class="bi bi-file-word me-2"></i>Word Document Guidelines
              </h6>
              <p class="mb-0">
                Similar to PDF but with better text recognition. Use consistent
            ...
            <div class="row">
              <div class="col-md-8">
                ...
                <div class="bg-light p-3 rounded">
                  ...
                  >
                    ...
                    <p>
                      A. Store data permanently<br />
                      B. Execute instructions and perform calculations<br />
                      C. Display information to the user<br />
                      D. Connect to the internet
                    </p>
                    <p>
                      <em>Correct Answer: B</em><br />
                      <em>Marks: 2</em><br />
                      <em>Tags: hardware, cpu, computer-science</em>
                    </p>
                    ...
                    <p>
                      <em>Type: Essay</em><br />
                      <em>Marks: 15</em><br />
                      <em>Tags: cloud-computing, business, technology</em>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <h6>
                  <i class="bi bi-gear me-2"></i>Formatting Best Practices
                </h6>
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled small">
                      <li>
                        ...
                        ><strong>Bold</strong> for question numbers
                      </li>
                      <li>
                        <i class="bi bi-check text-success me-2"></i
                        ><em>Italic</em> for answers and metadata
                      </li>
                      <li>
                        <i class="bi bi-check text-success me-2"></i>Consistent
                        indentation
                      </li>
                      <li>
                        <i class="bi bi-check text-success me-2"></i>Clear line
                    ...
                    <ul class="list-unstyled small">
                      <li>
                        <i class="bi bi-x text-danger me-2"></i>Mixed fonts in
                        same document
                      </li>
                      <li>
                        <i class="bi bi-x text-danger me-2"></i>Complex tables
                        or columns
                      </li>
                      <li>
                        <i class="bi bi-x text-danger me-2"></i>Images with text
                      </li>
                      <li>
                        <i class="bi bi-x text-danger me-2"></i>Headers and
                        footers
                      </li>
                    </ul>
                  </div>
                ...
                <div class="card p-0 border-success">
                  ...
                  <div class="card-body">
                    <ul class="list-unstyled mb-0">
                      <li>
                        <i class="bi bi-check text-success me-2"></i>Test with a
                        small file first
                      </li>
                      <li>
                        <i class="bi bi-check text-success me-2"></i>Review
                        imported questions before publishing
                      </li>
                      <li>
                        <i class="bi bi-check text-success me-2"></i>Use
                        consistent formatting throughout
                      </li>
                      <li>
                        <i class="bi bi-check text-success me-2"></i>Include
                        clear answer keys
                      </li>
                      <li>
                        <i class="bi bi-check text-success me-2"></i>Specify
              ...
              <div class="col-md-6">
                <div class="card p-0 border-warning">
                  <div class="card-header bg-warning text-dark">
                    <h6 class="mb-0">
                      <i class="bi bi-exclamation-triangle me-2"></i>Common
                      Issues
                    </h6>
                  </div>
                  <div class="card-body">
                    <ul class="list-unstyled mb-0">
                      <li>
                        <i class="bi bi-x text-danger me-2"></i>Missing column
                        headers in Excel
                      </li>
                      <li>
                        <i class="bi bi-x text-danger me-2"></i>Inconsistent
                        answer formats
                      </li>
                      <li>
                        <i class="bi bi-x text-danger me-2"></i>Special
                        characters in questions
                      </li>
                      <li>
                        <i class="bi bi-x text-danger me-2"></i>Empty rows or
                        incomplete data
                      </li>
                      <li>
                        <i class="bi bi-x text-danger me-2"></i>Files larger
                        than 10MB
                      </li>
                    </ul>
                  </div>
