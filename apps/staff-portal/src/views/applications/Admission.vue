    ...
    initializeDropdowns() {
      this.$nextTick(() => {
        try {
          ...
          if (typeof window.bootstrap === 'undefined' || typeof Dropdown === 'undefined') {
            logger.warn('Bootstrap not fully loaded, retrying dropdown initialization...');
    ...
    async viewApplication(application) {
      try {
        ...
        if (response.success) {
          ...
          logger.info("Application details loaded:", this.selectedApplicationDetails);
        } else {
          this.$swal.fire({
            icon: 'error',
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h5 id="applicationDetailsModalLabel" class="modal-title">
            ...
            Application Details
            <span v-if="selectedApplicationDetails" class="badge bg-primary ms-2">
          ...
          <div v-else-if="selectedApplicationDetails" class="row g-4">
                ...
                <div class="card-body">
                  <div class="row g-3">
                    ...
                    <div class="col-12">
                      ...
                      <p class="form-control-plaintext">{{ selectedApplicationDetails.userId.email || 'N/A' }}</p>
                    </div>
                    <div class="col-12">
                      <label class="form-label fw-semibold">Phone Number</label>
                      <p class="form-control-plaintext">{{ selectedApplicationDetails.phone || 'N/A' }}</p>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-6">
                      ...
                      <p class="form-control-plaintext">{{ selectedApplicationDetails.gender || 'N/A' }}</p>
                    </div>
                    <div class="col-6">
                      <label class="form-label fw-semibold">Marital Status</label>
                      <p class="form-control-plaintext">{{ selectedApplicationDetails.maritalStatus || 'N/A' }}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="card p-0 h-100">
                <div class="card-header">
                  <h6 class="card-title mb-0">
                    <i class="bi bi-clipboard-data me-2"></i>Application Information
                  </h6>
                </div>
                <div class="card-body">
                  <div class="row g-3">
                    <div class="col-12">
                      <label class="form-label fw-semibold">Program Applied For</label>
                      <p class="form-control-plaintext">{{ selectedApplicationDetails.programId.name || 'N/A' }}</p>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <p class="form-control-plaintext">
                        <span :class="getStatusBadgeClass(selectedApplicationDetails.status)">
                          {{ selectedApplicationDetails.status?.toUpperCase() || 'N/A' }}
                        </span>
                      </p>
                    </div>
                    <div class="col-12">
                ...
                <div class="card-body">
                  <div class="row g-3">
                    <div class="col-12">
                      ...
                      <p class="form-control-plaintext">{{ selectedApplicationDetails.address || 'N/A' }}</p>
                    </div>
                    <div class="col-6">
                      <label class="form-label fw-semibold">State</label>
                      <p class="form-control-plaintext">{{ selectedApplicationDetails.stateOfOrigin || 'N/A' }}</p>
                    </div>
                    <div class="col-6">
                      <label class="form-label fw-semibold">LGA</label>
                      <p class="form-control-plaintext">{{ selectedApplicationDetails.lga || 'N/A' }}</p>
                    </div>
                    <div class="col-12">
                      <label class="form-label fw-semibold">Emergency Contact Name</label>
                      <p class="form-control-plaintext">{{ selectedApplicationDetails.nextOfKin.name || 'N/A' }}</p>
                    </div>
                    <div class="col-12">
                      <label class="form-label fw-semibold">Emergency Contact Phone</label>
                      <p class="form-control-plaintext">{{ selectedApplicationDetails.nextOfKin.phone || 'N/A' }}</p>
                    </div>
                    <div class="col-12">
            ...
            <div class="col-md-6">
              <div class="card p-0 h-100">
                ...
                <div class="card-body">
                    ...
                    <div v-if="selectedApplicationDetails.entranceExam">
                      <div class="row g-2">
                        ...
                        <div class="col-6">
                          ...
                          <p class="mb-1">{{ selectedApplicationDetails.entranceExam.time || 'N/A' }}</p>
                        </div>
                        <div class="col-12">
                  ...
                  <!-- Screening -->
                  <div>
                    <h6 class="fw-semibold text-primary">Screening & Interview</h6>
                    <div v-if="selectedApplicationDetails.screening">
                      <div class="row g-2">
                        ...
                        <div class="col-6">
                          <small class="text-muted">Time:</small>
                          <p class="mb-1">{{ selectedApplicationDetails.screening.time || 'N/A' }}</p>
                        </div>
                        <div class="col-12">
                          <small class="text-muted">Venue:</small>
                          <p class="mb-1">{{ selectedApplicationDetails.screening.venue || 'N/A' }}</p>
                        </div>
                        <div class="col-12">
                ...
                <div class="card-body">
                  <div class="row g-3">
                        ...
                        <div v-for="(result, index) in selectedApplicationDetails.documents.olevelResults" :key="index"
                          ...
                          <p class="mb-1">
                            <a :href="result" target="_blank" class="text-decoration-none">
                              View Document <i class="bi bi-box-arrow-up-right ms-1"></i>
                            </a>
                          </p>
                        </div>
                      </div>
                      <p v-else class="text-muted">No O'Level results uploaded</p>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <p v-else class="text-muted">No reference letters uploaded</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- Admission Decision -->
            <div v-if="selectedApplicationDetails.admissionDecision" class="col-12">
              <div class="card p-0">
                <div class="card-header">
                  <h6 class="card-title mb-0">
                ...
                <div class="card-body">
                  <div class="row g-3">
                    ...
                    <div v-if="selectedApplicationDetails.rejectionReason" class="col-12">
                      <label class="form-label fw-semibold">Rejection Reason</label>
                      <p class="form-control-plaintext">{{ selectedApplicationDetails.rejectionReason }}</p>
                    </div>
                  </div>
                </div>
              </div>
